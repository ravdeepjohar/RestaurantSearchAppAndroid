...
import com.userinterface.SearchCusineInterface;
...
public class SearchCusine extends ListActivity {

	 String urlbase="https://maps.googleapis.com/maps/api/place/search/json?location=41.8829,-87.6307&radius=10000&types=food&name=";
	 String urlend="&sensor=false&key=AIzaSyA_MHRnqvU3DPXn3qpfLYF_7_RkOSBEcR8";
	 String urlg=SearchCusineInterface.searchText.getText().toString().trim();
...
lv.setOnItemClickListener(new OnItemClickListener() {
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {        		
		...
		Toast.makeText(SearchCusine.this, "ID '" + o.get("id") + "' was clicked.", Toast.LENGTH_SHORT).show();
